...
export async function POST(request:Request){
 ...
 try{
  switch(action){
   ...
   case 'approve-historical-draft':if(get('confirmHistoricalInitial')!=='yes')throw new Error('Explicit confirmation is required to publish this historical game once.');await approveDraft(get('outboxId'),session.userId,{authorizeHistoricalInitial:true});break;
