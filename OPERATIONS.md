...
3. After backup succeeds, bootstrap applies additive migrations and ensures the existing operator account. It does not reimport bundles or force an R run. Web and worker can start after bootstrap.
