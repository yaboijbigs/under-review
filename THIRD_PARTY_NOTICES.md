...
- **nflverse officials and expected-performance reference:** the officials source archive and transformed regular-season/referee reference in `packages/core/reference/` retain CC BY 4.0. The reference README and source metadata record original URLs, checksums, attribution, regular-season filtering, name aliases, GSIS joins and conflicting-assignment exclusions.
